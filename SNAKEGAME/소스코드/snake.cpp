...
Snake::Snake()
{
	...
	ready_rect = { 0, 0, 613, 278 };
	ready_dest = { 230, 160, 350, 270 };
...
void Snake::GenerateFood()
{
	...
	if (!free_points.empty()) {
		int index = rand() % free_points.size();
		food_x = free_points[index].x;
		food_y = free_points[index].y;
